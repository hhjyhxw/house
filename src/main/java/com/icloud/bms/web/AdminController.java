...
import com.icloud.bms.service.AdminRoleService;
import com.icloud.bms.service.AdminService;
import com.icloud.bms.service.RoleService;
...
public class AdminController extends AdminBaseController<BmsAdmin> {
	...
	public String toinput(Integer id,HttpServletRequest request) throws Exception{
		...
		if(id!=null){
		   ...
		   if(null!=admin.getShopIds() && !"".equals(admin.getShopIds())){
			   List<String> shopids = JSONArray.parseArray(admin.getShopIds(), String.class);
		   }
	...
	public String input(HttpServletRequest request,HttpServletResponse response,Integer id) throws Exception{
		...
		String[] shopids = request.getParameterValues("shopId");
 		if(id==null){
			...
			if(null!=shopids){
		    	admin.setShopIds(JSONArray.toJSONString(Arrays.asList(shopids)));
			}
