 ...
 */
@Controller
    @RequestMapping(value = "${backPath}/officeBuildingRent")
public class HouseOfficeBuildingRentController extends BaseIdLongController<HouseHousingService,HouseHousing> {
   ...
   private HouseAreaService houseAreaService;
	...
	public String list(HouseHousing t, @RequestParam Map<String, Object> params) {
        ...
        query.put("rentable","1");//是否可以租(0不可以组,1可以组
        ...
        return "house/housing/house_office_buildingrent_list";
	}

	@Override
	public String toinput(Long id) {
		Object houseHousing = baseService.getById(id);
      /*  request.setAttribute("arenList", houseAreaService.getList());*/
		request.setAttribute("record", houseHousing);
		return "house/housing/house_office_buildingrent_input";
	}
