 ...
 */
@Controller
@RequestMapping(value = "${backPath}/shareOffice")
public class HouseShareOfficeController extends BaseIdLongController<HouseHousingService,HouseHousing> {

    @Override
	public String list(HouseHousing t, @RequestParam Map<String, Object> params) {
		Query query =  new Query(params);
        query.put("house_type","3");//分类（1、写字楼、2 新房 3、共享办公、4租房）
        ...
        return "house/housing/house_share_office_list";
	}
	...
	public String toinput(Long id) {
		...
		return "house/housing/house_share_office_input";
	}
}